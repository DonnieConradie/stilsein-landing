...
const translations = {
  en: {
    ...
    eco_2_desc: "Watch your digital cylinder fill up dynamically as the rain falls. Instantly toggle to detailed historical charts to track long-term water metrics.",
    eco_3_title: "LIVE RAIN SPELLS",
    eco_3_desc: "During a storm, the system shifts into high gear with 5-minute pulse intervals. Watch animated raindrops intensify based on real-time downpours.",
    eco_4_title: "PRESSURE NETWORK",
    eco_4_desc: "A bird's-eye view of your entire irrigation system. Compare live pressure metrics from multiple gauges simultaneously on a single fullscreen chart.",
    eco_5_title: "INDIVIDUAL PIPES",
    eco_5_desc: "Zoom in on a specific pipeline. See the animated water pressure rise and drop, backed by precise fullscreen graphing to detect leaks or blockages.",
    eco_6_title: "SATELLITE FORECAST",
    eco_6_desc: "Stay steps ahead. Advanced satellite data predicts upcoming weather events specific to your farm's exact GPS coordinates.",
    eco_7_title: "INTERACTIVE MAPS",
    eco_7_desc: "See your nodes plotted on the farm. Built-in GPS tracks your exact location relative to your hardware and their live readings.",
    eco_8_title: "FARM ARCHIVE",
    eco_8_desc: "Your digital farm history. Every rainspell, heatwave, and critical event is automatically logged, ready to be expanded into detailed fullscreen charts.",
    eco_9_title: "JAKKALS & EXPORT",
    eco_9_desc: "Chat with Jakkals AI for tailored farm advice. When ready, download filtered PDF and CSV reports with just a few taps.",
  ...
  af: {
    ...
    eco_2_desc: "Kyk hoe jou digitale silinder dinamies vul soos dit reën. Skakel blitsvinnig oor na gedetailleerde historiese grafieke om langtermyn syfers na te spoor.",
    eco_3_title: "LEWENDIGE REËNBUIE",
    eco_3_desc: "Tydens 'n storm skakel die stelsel oor na vinnige 5-minute polse. Kyk hoe geanimeerde reëndruppels intyds verskerp soos die buie uitsak.",
    eco_4_title: "DRUKNETWERK",
    eco_4_desc: "'n Oorsig van jou hele besproeiingstelsel. Vergelyk lewendige druksyfers van verskeie meters gelyktydig op een volskerm grafiek.",
    eco_5_title: "INDIVIDUELE PYPE",
    eco_5_desc: "Zoom in op 'n spesifieke pyplyn. Sien die geanimeerde waterdruk styg en daal, gerugsteun deur presiese grafieke om lekkasies op te spoor.",
    eco_6_title: "SATELLIET VOORSPELLING",
    eco_6_desc: "Bly treë voor. Gevorderde satellietdata voorspel opkomende weergebeurtenisse spesifiek vir jou plaas se presiese GPS-koördinate.",
    eco_7_title: "INTERAKTIEWE KAARTE",
    eco_7_desc: "Sien jou nodes op die plaas ontplooi. Ingeboude GPS volg jou presiese ligging relatief tot jou hardeware en hul lewendige lesings.",
    eco_8_title: "PLAAS ARGIEF",
    eco_8_desc: "Jou digitale plaasgeskiedenis. Elke reënbui, hittegolf en kritiese gebeurtenis word outomaties gestoor, gereed om in detail oopgemaak te word.",
    eco_9_title: "JAKKALS & EXPORTS",
    eco_9_desc: "Gesels met Jakkals AI vir pasgemaakte boerdery-advies. Laai daarna gefiltreerde PDF en CSV verslae af met 'n paar klieks.",
