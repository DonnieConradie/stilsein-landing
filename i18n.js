...
const translations = {
  en: {
    ...
    grid_rain_exp: "Industrial-grade tipping bucket sensors capture every millimeter. They run on a 10-year battery and beam data over a 15km LoRaWAN radio frequency directly to your homestead.",
    ...
    grid_jakkals_exp: "A localized AI model configured with your farm's size, livestock, and thresholds. It constantly scans incoming sensor data and flags anomalies before they become crises.",
    ...
    grid_alerts_exp: "You set the rules. If pressure drops below 2 bar, or rainfall exceeds 50mm, the system instantly pushes a high-priority notification to your smartphone.",
  ...
  af: {
    ...
    grid_rain_exp: "Industriële kantel-emmer sensors vang elke millimeter op. Dit werk op 'n 10-jaar battery en stuur data oor 'n 15km LoRaWAN radiofrekwensie direk na die opstal.",
    grid_pipe: "PYPDRUK",
    ...
    grid_jakkals: "JAKKALS AI",
    grid_jakkals_exp: "'n Gelokaliseerde AI-model gekonfigureer met jou plaas se grootte, vee en drempels. Hy skandeer voortdurend inkomende data en waarsku jou oor afwykings voor dit krisisse word.",
    ...
    grid_alerts_exp: "Jy stel die reëls. As die druk onder 2 bar val, of reënval 50mm oorskry, stuur die stelsel onmiddellik 'n hoë-prioriteit kennisgewing na jou slimfoon.",
